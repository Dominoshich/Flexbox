...
const questions = 
[
	new Question("Какое значение по умолчанию присваивается свойству flex-direction?", 
	[
		new Answer("row", 1),
		new Answer("column", 0),
		new Answer("row-reverse", 0)
	]),

	new Question("Какое значение свойства flex-direction располагает дочерние элементы в виде столбцов?", 
	[
		new Answer("row-reverse", 0),
		new Answer("column", 1),
		new Answer("row", 0)
	...
	new Question("Какое значение свойства flex-direction располагает дочерние элементы в обратном направлении строк?", 
	[
		new Answer("column", 0),
		new Answer("row-reverse", 1),
		new Answer("row", 0)
	]),

	new Question("Какое свойство следует добавить в CSS, чтобы расположить элементы в виде столбцов?", 
	[
		new Answer("flex-direction: row", 0),
		new Answer("flex-direction: column", 1),
		new Answer("flex-direction: row-reverse", 0)
	]),

	new Question("Как распологает дочерние элементы flex-direction: row?", 
	[
		new Answer("Дочерние элементы стоят в ряд слева направо ", 1),
		new Answer("Дочерние элементы стоят в ряд справа налево", 0),
		new Answer("Дочерние элементы расположены в виде столбцов", 0)
	]),

	new Question("Какое значение свойства flex-direction располагает дочерние элементы в обратном направлении столбцов?", 
	[
		new Answer("column-reverse", 1),
		new Answer("row-reverse", 0),
		new Answer("row", 0)
	])
];
	...
	else
	{
        ...
        <div class="result_block result_block_remove">
          ...
          <div class="inputs_of_results">
            ...
            <input type="submit" value="Следующий урок" onclick="document.location='../lesson/lesson4.html'">
          </div>
        </div>
      `;
