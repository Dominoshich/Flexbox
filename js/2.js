...
const questions = 
[
	new Question("Как называется ось, которая проходит вдоль Flex элементов?", 
	[
		new Answer("Основная ось", 0),
		new Answer("Поперечная ось", 0),
		new Answer("Главная ось", 1)
	]),

	new Question("Как называется ось, которая проходит перпендикулярно Flex элементам?", 
	[
		new Answer("Основная ось", 0),
		new Answer("Поперечная ось", 1),
		new Answer("Вторичная ось", 0)
	]),

	new Question("Как называется родительский элемент, на который назначено свойство display: flex?", 
	[
		new Answer("Flex block", 0),
		new Answer("Flex container", 1),
		new Answer("Flex element", 0)
	]),

	new Question("Как называются элементы, размещенные внутри Flex контейнера?", 
	[
		new Answer("Flex items", 1),
		new Answer("Flex container", 0),
		new Answer("Flex element", 0)
	]),

	new Question("Как называют начало Главной оси?", 
	[
		new Answer("begin main", 0),
		new Answer("main start", 1),
		new Answer("start main", 0)
	]),

	new Question("Что следует запомнить из текста?", 
	[
		new Answer("Основная ось и поперечная ось", 0),
		new Answer("Родительский элемент и Flex элементы", 0),
		new Answer("Все перечисленные термины", 1)
	])
];
	...
	else
	{
        ...
        <div class="result_block result_block_remove">
          ...
          <div class="inputs_of_results">
            ...
            <input type="submit" value="Следующий урок" onclick="document.location='../lesson/lesson3.html'">
          </div>
        </div>
      `;
